...
namespace SprCs {
	...
	public ObjectIf Top() {
	    IntPtr ptr = SprExport.Spr_ObjectIfs_Top((IntPtr) _this);
            ...
            if (obj.GetIfInfo() == UTOptimizerIf.GetIfInfoStatic()) { return new UTOptimizerIf(ptr); }
            return obj;
	}
    }
    ...
    public partial class UTCMAESOptimizerDesc : CsObject {
	public UTCMAESOptimizerDesc() { _this = SprExport.Spr_new_UTCMAESOptimizerDesc(); _flag = true; }
	public UTCMAESOptimizerDesc(IntPtr ptr) : base(ptr) {}
	public UTCMAESOptimizerDesc(IntPtr ptr, bool flag) : base(ptr, flag) {}
	~UTCMAESOptimizerDesc() { if (_flag) { SprExport.Spr_delete_UTCMAESOptimizerDesc(_this); _flag = false; } }
	public double stopMaxFunEvals {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopMaxFunEvals(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopMaxFunEvals(_this, value); }
	}
	public double facmaxeval {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_facmaxeval(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_facmaxeval(_this, value); }
	}
	public double stopMaxIter {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopMaxIter(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopMaxIter(_this, value); }
	}
	public double stopTolFun {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopTolFun(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopTolFun(_this, value); }
	}
	public double stopTolFunHist {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopTolFunHist(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopTolFunHist(_this, value); }
	}
	public double stopTolX {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopTolX(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopTolX(_this, value); }
	}
	public double stopTolUpXFactor {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_stopTolUpXFactor(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_stopTolUpXFactor(_this, value); }
	}
	public int lambda {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_lambda(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_lambda(_this, value); }
	}
	public int mu {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_mu(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_mu(_this, value); }
	}
	public double mucov {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_mucov(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_mucov(_this, value); }
	}
	public double mueff {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_mueff(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_mueff(_this, value); }
	}
        public vectorwrapper_double weights {
            get { return new vectorwrapper_double(SprExport.Spr_UTCMAESOptimizerDesc_vector_addr_weights(_this)); }
            set { SprExport.Spr_UTCMAESOptimizerDesc_vector_set_weights(_this, value); }
        }
	public double damps {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_damps(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_damps(_this, value); }
	}
	public double cs {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_cs(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_cs(_this, value); }
	}
	public double ccumcov {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_ccumcov(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_ccumcov(_this, value); }
	}
	public double ccov {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_ccov(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_ccov(_this, value); }
	}
	public double diagonalCov {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_diagonalCov(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_diagonalCov(_this, value); }
	}
	public double facupdateCmode {
	    get { return SprExport.Spr_UTCMAESOptimizerDesc_get_facupdateCmode(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_facupdateCmode(_this, value); }
	}
	public enum Weights : int {
	    UTCMA_UNINITIALIZED_WEIGHTS = 0, UTCMA_LINEAR_WEIGHTS = UTCMA_UNINITIALIZED_WEIGHTS + 1, UTCMA_EQUAL_WEIGHTS = UTCMA_LINEAR_WEIGHTS + 1, UTCMA_LOG_WEIGHTS = UTCMA_EQUAL_WEIGHTS + 1
	}
	public Weights weightMode {
	    get { return (Weights) SprExport.Spr_UTCMAESOptimizerDesc_get_weightMode(_this); }
	    set { SprExport.Spr_UTCMAESOptimizerDesc_set_weightMode(_this, (int) value); }
	}
    }
    [System.Serializable]
    public class UTCMAESOptimizerDescStruct : CsObject {
        public UTCMAESOptimizerDescStruct() {
            UTCMAESOptimizerDesc desc = new UTCMAESOptimizerDesc();
	...
	public double mucov;
	public double mueff;
	public vectorwrapper_double weights = new vectorwrapper_double();
	public double damps;
	public double cs;
	public double ccumcov;
	public double ccov;
	public double diagonalCov;
	public double facupdateCmode;
// _[Find class node: 2916] UTCMAESOptimizerDesc
	public void ApplyTo(UTCMAESOptimizerDesc r, bool apply_to_base_class=true) {
		r.stopMaxFunEvals = stopMaxFunEvals;
		r.facmaxeval = facmaxeval;
		r.stopMaxIter = stopMaxIter;
		r.stopTolFun = stopTolFun;
		r.stopTolFunHist = stopTolFunHist;
		r.stopTolX = stopTolX;
		r.stopTolUpXFactor = stopTolUpXFactor;
		r.lambda = lambda;
		r.mu = mu;
		r.mucov = mucov;
		r.mueff = mueff;
		r.weights.clear();
		int _UTCMAESOptimizerDesc_count_0011 = weights.size();
		for (int i = 0; i < _UTCMAESOptimizerDesc_count_0011; i++) {
		...
		r.ccumcov = ccumcov;
		r.ccov = ccov;
		r.diagonalCov = diagonalCov;
		r.facupdateCmode = facupdateCmode;
	}
	public void ApplyFrom(UTCMAESOptimizerDesc r, bool apply_to_base_class=true) {
		stopMaxFunEvals = r.stopMaxFunEvals;
		facmaxeval = r.facmaxeval;
		stopMaxIter = r.stopMaxIter;
		stopTolFun = r.stopTolFun;
		stopTolFunHist = r.stopTolFunHist;
		stopTolX = r.stopTolX;
		stopTolUpXFactor = r.stopTolUpXFactor;
		lambda = r.lambda;
		mu = r.mu;
		mucov = r.mucov;
		mueff = r.mueff;
		weights.clear();
		int _UTCMAESOptimizerDesc_count_0011 = r.weights.size();
		for (int i = 0; i < _UTCMAESOptimizerDesc_count_0011; i++) {
		...
		ccumcov = r.ccumcov;
		ccov = r.ccov;
		diagonalCov = r.diagonalCov;
		facupdateCmode = r.facupdateCmode;
	}
	public static implicit operator UTCMAESOptimizerDesc(UTCMAESOptimizerDescStruct m) {
	    UTCMAESOptimizerDesc r = new UTCMAESOptimizerDesc();
	    m.ApplyTo(r, true);
	    return r;
	}
	public static implicit operator UTCMAESOptimizerDescStruct(UTCMAESOptimizerDesc r) {
	    UTCMAESOptimizerDescStruct m = new UTCMAESOptimizerDescStruct();
	    m.ApplyFrom(r, true);
	    return m;
	}
    }
...
// _[Find class node: 2916] Affined
	...
	public ObjectIf GetChildObject(ulong pos) {
	    IntPtr ptr = SprExport.Spr_ObjectIf_GetChildObject((IntPtr) _this, (ulong) pos);
            ...
            if (obj.GetIfInfo() == UTCMAESOptimizerIf.GetIfInfoStatic()) { return new UTCMAESOptimizerIf(ptr); }
            return obj;
	}
    ...
    public partial class UTOptimizerIf : ObjectIf {
	public UTOptimizerIf() { _this = SprExport.Spr_new_UTOptimizerIf(); _flag = true; }
	public UTOptimizerIf(IntPtr ptr) : base(ptr) {}
	public UTOptimizerIf(IntPtr ptr, bool flag) : base(ptr, flag) {}
	public static implicit operator UTOptimizerIf(CsCastObject target) {
		return (target._info.Inherit(UTOptimizerIf.GetIfInfoStatic()) ? new UTOptimizerIf(target._this, target._flag) : null);
	}
	~UTOptimizerIf() { if (_flag) { SprExport.Spr_delete_UTOptimizerIf(_this); _flag = false; } }
        public override string ToString() {
            IntPtr ptr = SprExport.Spr_UTOptimizerIf_ToString((IntPtr) _this);
            string bstr = Marshal.PtrToStringBSTR(ptr);
            SprExport.Spr_UTOptimizerIf_FreeString((IntPtr) ptr);
            return bstr;
        }
	public IfInfo GetIfInfo() {
	    IntPtr ptr = SprExport.Spr_UTOptimizerIf_GetIfInfo((IntPtr) _this);
            return new IfInfo(ptr);
	}
	public static IfInfo GetIfInfoStatic() {
	    IntPtr ptr = SprExport.Spr_UTOptimizerIf_GetIfInfoStatic();
            return new IfInfo(ptr);
	}
	public void SetDimension(int dimension) {
	    SprExport.Spr_UTOptimizerIf_SetDimension((IntPtr) _this, (int) dimension);
	}
	public int GetDimension() {
	    int result = (int) SprExport.Spr_UTOptimizerIf_GetDimension((IntPtr) _this);
	    return result;
	}
	public void SetInitialValue(double initialValue) {
	    SprExport.Spr_UTOptimizerIf_SetInitialValue((IntPtr) _this, (double) initialValue);
	}
	public void Initialize() {
	    SprExport.Spr_UTOptimizerIf_Initialize((IntPtr) _this);
	}
	public double[] GetPopulation() {
	    IntPtr ptr = SprExport.Spr_UTOptimizerIf_GetPopulation((IntPtr) _this);
	...
	public void SetObjectiveFunctionValue(double value) {
	    SprExport.Spr_UTOptimizerIf_SetObjectiveFunctionValue((IntPtr) _this, (double) value);
	}
	public void Next() {
	    SprExport.Spr_UTOptimizerIf_Next((IntPtr) _this);
	}
	public bool IsFinished() {
	    char ret = SprExport.Spr_UTOptimizerIf_IsFinished((IntPtr) _this);
	    return (ret == 0) ? false : true;
	}
	public double[] GetResult() {
	    IntPtr ptr = SprExport.Spr_UTOptimizerIf_GetResult((IntPtr) _this);
            int size = 1;   // no way to know array size!
            return new arraywrapper_double(ptr, size);
	}
	public double GetFitness() {
	    double result = (double) SprExport.Spr_UTOptimizerIf_GetFitness((IntPtr) _this);
	    return result;
	}
    }
    public partial class UTCMAESOptimizerIf : UTOptimizerIf {
	public UTCMAESOptimizerIf() { _this = SprExport.Spr_new_UTCMAESOptimizerIf(); _flag = true; }
	public UTCMAESOptimizerIf(IntPtr ptr) : base(ptr) {}
	public UTCMAESOptimizerIf(IntPtr ptr, bool flag) : base(ptr, flag) {}
	public static implicit operator UTCMAESOptimizerIf(CsCastObject target) {
		return (target._info.Inherit(UTCMAESOptimizerIf.GetIfInfoStatic()) ? new UTCMAESOptimizerIf(target._this, target._flag) : null);
	}
	~UTCMAESOptimizerIf() { if (_flag) { SprExport.Spr_delete_UTCMAESOptimizerIf(_this); _flag = false; } }
        public override string ToString() {
            IntPtr ptr = SprExport.Spr_UTCMAESOptimizerIf_ToString((IntPtr) _this);
            string bstr = Marshal.PtrToStringBSTR(ptr);
            SprExport.Spr_UTCMAESOptimizerIf_FreeString((IntPtr) ptr);
            return bstr;
        }
	public IfInfo GetIfInfo() {
	    IntPtr ptr = SprExport.Spr_UTCMAESOptimizerIf_GetIfInfo((IntPtr) _this);
            return new IfInfo(ptr);
	}
	public static IfInfo GetIfInfoStatic() {
	    IntPtr ptr = SprExport.Spr_UTCMAESOptimizerIf_GetIfInfoStatic();
            return new IfInfo(ptr);
	}
	public void SetInitialValue(double initialValue) {
	    SprExport.Spr_UTCMAESOptimizerIf_SetInitialValue((IntPtr) _this, (double) initialValue);
	}
	public void SetInitialStdDev(double initialStdDev) {
	    SprExport.Spr_UTCMAESOptimizerIf_SetInitialStdDev((IntPtr) _this, (double) initialStdDev);
	}
	public int GetCurrentGeneration() {
	    int result = (int) SprExport.Spr_UTCMAESOptimizerIf_GetCurrentGeneration((IntPtr) _this);
	    return result;
	}
	public int GetCurrentPopulation() {
	    int result = (int) SprExport.Spr_UTCMAESOptimizerIf_GetCurrentPopulation((IntPtr) _this);
	    return result;
	}
	public static UTCMAESOptimizerIf Create(UTCMAESOptimizerDesc desc) {
	    IntPtr ptr = SprExport.Spr_UTCMAESOptimizerIf_Create((IntPtr) desc);
            if (ptr == IntPtr.Zero) { return null; } 
            UTCMAESOptimizerIf obj = new UTCMAESOptimizerIf(ptr);
            return obj;
	}
	public static UTCMAESOptimizerIf Create() {
	    IntPtr ptr = SprExport.Spr_UTCMAESOptimizerIf_Create_1();
            if (ptr == IntPtr.Zero) { return null; } 
            UTCMAESOptimizerIf obj = new UTCMAESOptimizerIf(ptr);
            return obj;
	}
	public double GetCs() {
	    double result = (double) SprExport.Spr_UTCMAESOptimizerIf_GetCs((IntPtr) _this);
	    return result;
	}
	public double GetLambda() {
	    double result = (double) SprExport.Spr_UTCMAESOptimizerIf_GetLambda((IntPtr) _this);
	    return result;
	}
    }
	...
	public partial class IfInfoToCsType {
		public static Dictionary<IntPtr, Type> mapFoundation = new Dictionary<IntPtr, Type>() {
			...
			{UTOptimizerIf.GetIfInfoStatic(), typeof(UTOptimizerIf)},
			{UTCMAESOptimizerIf.GetIfInfoStatic(), typeof(UTCMAESOptimizerIf)},
		};
	}
}

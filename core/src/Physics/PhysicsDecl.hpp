...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		regularization = ((PHConstraintEngineDesc*)ptr)->regularization;	\
	...
	virtual bool GetDesc(void* ptr) const { \
		...
		((PHConstraintEngineDesc*)ptr)->regularization = regularization;	\
...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		regularizeParam2 = ((PHIKEngineDesc*)ptr)->regularizeParam2;	\
		regularizeMode = ((PHIKEngineDesc*)ptr)->regularizeMode;	\
		iterGaussSeidel = ((PHIKEngineDesc*)ptr)->iterGaussSeidel;	\
		solverMode = ((PHIKEngineDesc*)ptr)->solverMode;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		...
		((PHIKEngineDesc*)ptr)->regularizeParam2 = regularizeParam2;	\
		((PHIKEngineDesc*)ptr)->regularizeMode = regularizeMode;	\
		((PHIKEngineDesc*)ptr)->iterGaussSeidel = iterGaussSeidel;	\
		((PHIKEngineDesc*)ptr)->solverMode = solverMode;	\
		return true;	\
	}\
...
public:\
	virtual void SetState(const void* ptr){ \
		...
		solidPullbackPose = ((PHIKActuatorState*)ptr)->solidPullbackPose;	\
		jointTempPose = ((PHIKActuatorState*)ptr)->jointTempPose;	\
	}\
	virtual bool GetState(void* ptr) const { \
		...
		((PHIKActuatorState*)ptr)->solidPullbackPose = solidPullbackPose;	\
		((PHIKActuatorState*)ptr)->jointTempPose = jointTempPose;	\
		return true;	\
	}\
...
#define SPR_DECLMEMBEROF_PHIKSpringActuatorDesc \
protected:\
	Posed	pullbackTarget;	\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
		PHIKActuator::SetDesc((PHIKActuatorDesc*)(PHIKSpringActuatorDesc*)ptr);	\
		pullbackTarget = ((PHIKSpringActuatorDesc*)ptr)->pullbackTarget;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		PHIKActuator::GetDesc((PHIKActuatorDesc*)(PHIKSpringActuatorDesc*)ptr);	\
		((PHIKSpringActuatorDesc*)ptr)->pullbackTarget = pullbackTarget;	\
		return true;	\
	}\
...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		targetPosition = ((PHSpringDesc*)ptr)->targetPosition;	\
		targetOrientation = ((PHSpringDesc*)ptr)->targetOrientation;	\
		...
		targetVelocity = ((PHSpringDesc*)ptr)->targetVelocity;	\
		offsetForce = ((PHSpringDesc*)ptr)->offsetForce;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		PHJoint::GetDesc((PHJointDesc*)(PHSpringDesc*)ptr);	\
		((PHSpringDesc*)ptr)->targetPosition = targetPosition;	\
		((PHSpringDesc*)ptr)->targetOrientation = targetOrientation;	\
		...
		((PHSpringDesc*)ptr)->targetVelocity = targetVelocity;	\
		((PHSpringDesc*)ptr)->offsetForce = offsetForce;	\
		return true;	\
	}\
...
#define SPR_DECLMEMBEROF_PHHuman1DJointResistanceDesc \
protected:\
	Vec4d	coefficient;	\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
		PH1DJointNonLinearMotor::SetDesc((PH1DJointNonLinearMotorDesc*)(PHHuman1DJointResistanceDesc*)ptr);	\
		coefficient = ((PHHuman1DJointResistanceDesc*)ptr)->coefficient;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		PH1DJointNonLinearMotor::GetDesc((PH1DJointNonLinearMotorDesc*)(PHHuman1DJointResistanceDesc*)ptr);	\
		((PHHuman1DJointResistanceDesc*)ptr)->coefficient = coefficient;	\
		return true;	\
	}\
...
#define SPR_DECLMEMBEROF_PHHumanBallJointResistanceDesc \
protected:\
	Vec4d	xCoefficient;	\
	Vec4d	yCoefficient;	\
	Vec4d	zCoefficient;	\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
		PHBallJointNonLinearMotor::SetDesc((PHBallJointNonLinearMotorDesc*)(PHHumanBallJointResistanceDesc*)ptr);	\
		xCoefficient = ((PHHumanBallJointResistanceDesc*)ptr)->xCoefficient;	\
		yCoefficient = ((PHHumanBallJointResistanceDesc*)ptr)->yCoefficient;	\
		zCoefficient = ((PHHumanBallJointResistanceDesc*)ptr)->zCoefficient;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		PHBallJointNonLinearMotor::GetDesc((PHBallJointNonLinearMotorDesc*)(PHHumanBallJointResistanceDesc*)ptr);	\
		((PHHumanBallJointResistanceDesc*)ptr)->xCoefficient = xCoefficient;	\
		((PHHumanBallJointResistanceDesc*)ptr)->yCoefficient = yCoefficient;	\
		((PHHumanBallJointResistanceDesc*)ptr)->zCoefficient = zCoefficient;	\
		return true;	\
	}\
...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		pSingleVMass = ((PHOpParticleDesc*)ptr)->pSingleVMass;	\
	...
	virtual bool GetDesc(void* ptr) const { \
		...
		((PHOpParticleDesc*)ptr)->pSingleVMass = pSingleVMass;	\
...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		collisionCstrStiffness = ((PHOpSpHashColliAgentDesc*)ptr)->collisionCstrStiffness;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		((PHOpSpHashColliAgentDesc*)ptr)->useDirColli = useDirColli;	\
		((PHOpSpHashColliAgentDesc*)ptr)->collisionCstrStiffness = collisionCstrStiffness;	\
		return true;	\
	}\
...
public:\
	...
	virtual void SetDesc(const void* ptr){ \
		...
		airResistanceRateForVelocity = ((PHSceneDesc*)ptr)->airResistanceRateForVelocity;	\
		airResistanceRateForAngularVelocity = ((PHSceneDesc*)ptr)->airResistanceRateForAngularVelocity;	\
	...
	virtual bool GetDesc(void* ptr) const { \
		...
		((PHSceneDesc*)ptr)->airResistanceRateForVelocity = airResistanceRateForVelocity;	\
		((PHSceneDesc*)ptr)->airResistanceRateForAngularVelocity = airResistanceRateForAngularVelocity;	\

...
void RegisterTypeDescPhysics(UTTypeDescDbIf* db){
	...
	field = desc->AddField("", "bool", "bTimeVaryFriction", "");
	...
	field = desc->AddField("", "bool", "bSimulation", "");
	desc->SetOffset(field, int((char*)&(pPHHapticPointerPhysicsSt->bSimulation) - (char*)pPHHapticPointerPhysicsSt));
	field = desc->AddField("", "bool", "bMultiproxy", "");
	desc->SetOffset(field, int((char*)&(pPHHapticPointerPhysicsSt->bMultiproxy) - (char*)pPHHapticPointerPhysicsSt));
	field = desc->AddField("", "int", "proxyN", "");
	desc->SetOffset(field, int((char*)&(pPHHapticPointerPhysicsSt->proxyN) - (char*)pPHHapticPointerPhysicsSt));
	field = desc->AddField("", "int", "totalSlipState", "");
	desc->SetOffset(field, int((char*)&(pPHHapticPointerPhysicsSt->totalSlipState) - (char*)pPHHapticPointerPhysicsSt));
	field = desc->AddField("vector", "int", "slipState", "");
	desc->SetOffset(field, int((char*)&(pPHHapticPointerPhysicsSt->slipState) - (char*)pPHHapticPointerPhysicsSt));
	db->RegisterDesc(desc);
	...
	db->RegisterDesc(desc);
	Spr::PHSolidPairForHapticSt* pPHSolidPairForHapticSt = NULL;
	desc = UTTypeDescIf::Create("PHSolidPairForHapticSt");
	desc->SetSize(sizeof(Spr::PHSolidPairForHapticSt));
	desc->SetAccess(DBG_NEW UTAccess<Spr::PHSolidPairForHapticSt>);
	field = desc->AddField("", "Vec3d", "force", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->force) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Vec3d", "torque", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->torque) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Posed", "interpolationPose", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->interpolationPose) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Posed", "lastInterpolationPose", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->lastInterpolationPose) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Posed", "initialRelativePose", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->initialRelativePose) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Posed", "relativePose", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->relativePose) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "unsigned", "contactCount", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->contactCount) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "unsigned", "fricCount", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->fricCount) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("vector", "unsigned", "fricCounts", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->fricCounts) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("vector", "unsigned", "contactCounts", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->contactCounts) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("vector", "FrictionState", "frictionStates", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->frictionStates) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("vector", "int", "slipState", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->slipState) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Vec3d", "contactVibrationVel", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->contactVibrationVel) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "Vec3d", "lastStaticFrictionForce", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->lastStaticFrictionForce) - (char*)pPHSolidPairForHapticSt));
	field = desc->AddField("", "FrictionState", "frictionState", "");
	desc->SetOffset(field, int((char*)&(pPHSolidPairForHapticSt->frictionState) - (char*)pPHSolidPairForHapticSt));
	db->RegisterDesc(desc);
...
void Spr::PHHapticPointerIf::EnableMultiPoints(bool b){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->EnableMultiPoints(b);
}
bool Spr::PHHapticPointerIf::IsMultiPoints(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->IsMultiPoints();
}
void Spr::PHHapticPointerIf::EnableMultiProxy(bool b){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->EnableMultiProxy(b);
}
bool Spr::PHHapticPointerIf::IsMultiProxy(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->IsMultiProxy();
}
void Spr::PHHapticPointerIf::EnableSimulation(bool b){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->EnableSimulation(b);
}
bool Spr::PHHapticPointerIf::IsSimulation(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->IsSimulation();
}
...
SpatialVector Spr::PHHapticPointerIf::GetHapticForce(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->GetHapticForce();
}
SpatialVector Spr::PHHapticPointerIf::GetProxyVelocity(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->GetProxyVelocity();
}
void Spr::PHHapticPointerIf::SetProxyN(int n){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->SetProxyN(n);
}
int Spr::PHHapticPointerIf::GetProxyN(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->GetProxyN();
}
int Spr::PHHapticPointerIf::GetTotalSlipState(){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->GetTotalSlipState();
}
int Spr::PHHapticPointerIf::GetSlipState(int i){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->GetSlipState(i);
}
void Spr::PHHapticPointerIf::SetProxyVelocity(SpatialVector spv){
	return	((PHHapticPointer*)(Object*)(ObjectIf*)this)->SetProxyVelocity(spv);
}
void Spr::PHHapticPointerIf::AddHapticForce(const SpatialVector& f){
...
void Spr::PHHapticPointerIf::UpdateHumanInterface(const Posed& pose, const SpatialVector& vel){
...
double Spr::PHShapePairForHapticIf::GetMus(int id){
	return	((PHShapePairForHaptic*)(Object*)(ObjectIf*)this)->GetMus(id);
}
...
void Spr::PHSolidPairForHapticIf::InitFrictionState(int n){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->InitFrictionState(n);
}
void Spr::PHSolidPairForHapticIf::InitFrictionCount(int n){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->InitFrictionCount(n);
}
void Spr::PHSolidPairForHapticIf::InitContactCount(int n){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->InitContactCount(n);
}
void Spr::PHSolidPairForHapticIf::InitSlipState(int n){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->InitSlipState(n);
}
int Spr::PHSolidPairForHapticIf::GetSlipState(int i){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->GetSlipState(i);
}
...
Spr::PHSolidPairForHapticIf::FrictionState Spr::PHSolidPairForHapticIf::GetFrictionStates(int i){
	return	((PHSolidPairForHaptic*)(Object*)(ObjectIf*)this)->GetFrictionStates(i);
}

...
#define SPR_DECLMEMBEROF_FWJoyStickGLUTDesc \
protected:\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
...
#define SPR_DECLMEMBEROF_FWKeyMouseGLUTDesc \
protected:\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
...
#define SPR_DECLMEMBEROF_FWOptimizerDesc \
protected:\
	double	ixstart;	\
	double	istddev;	\
	double	iTolFun;	\
...
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
		ixstart = ((FWOptimizerDesc*)ptr)->ixstart;	\
		istddev = ((FWOptimizerDesc*)ptr)->istddev;	\
		iTolFun = ((FWOptimizerDesc*)ptr)->iTolFun;	\
		ilambda = ((FWOptimizerDesc*)ptr)->ilambda;	\
		iMaxIter = ((FWOptimizerDesc*)ptr)->iMaxIter;	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		((FWOptimizerDesc*)ptr)->ixstart = ixstart;	\
		((FWOptimizerDesc*)ptr)->istddev = istddev;	\
		((FWOptimizerDesc*)ptr)->iTolFun = iTolFun;	\
		((FWOptimizerDesc*)ptr)->ilambda = ilambda;	\
		((FWOptimizerDesc*)ptr)->iMaxIter = iMaxIter;	\
		return true;	\
	}\

#define SPR_DECLMEMBEROF_FWStaticTorqueOptimizerDesc \
protected:\
public:\
	virtual const void* GetDescAddress() const { return NULL; }\
	virtual void SetDesc(const void* ptr){ \
		FWOptimizer::SetDesc((FWOptimizerDesc*)(FWStaticTorqueOptimizerDesc*)ptr);	\
		AfterSetDesc();	\
	}\
	virtual bool GetDesc(void* ptr) const { \
		BeforeGetDesc();	\
		FWOptimizer::GetDesc((FWOptimizerDesc*)(FWStaticTorqueOptimizerDesc*)ptr);	\
		return true;	\
	}\
